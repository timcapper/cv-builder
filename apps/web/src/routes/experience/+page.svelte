...
<div class="w-full h-full px-2">
    <div class="flex w-full items-center">
        <h3 class="text-2xl font-medium text-left my-auto">Experience</h3>
        <div class="flex-grow"></div>
        <div class="tooltip tooltip-bottom" data-tip="Add experience">
            <a href="/experience/new" class="btn btn-ghost normal-case text-xl rounded-xl"><MynauiPlusCircle class="w-8 h-8" /></a>
        </div>
    </div>
    <div class="divider" />
</div>
